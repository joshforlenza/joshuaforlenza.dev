  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="font-bold">recent CS graduate from NYU. </span>I enjoy
      ...
      >
        ...
        <a
          ...
          target="_blank"
          className="bg-white text-gray-700 p-4 flex items-center gap-2 rounded-full focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition cursor-pointer border border-black/10 text-[1.35rem]"
        >
          <FaGithubSquare />
        </a>
      </motion.div>
